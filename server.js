...
console.log('MONGOOS_URI:', process.env.MONGOOS_URI);
...
app.use('/api/', require('./src/routes/courses')); //categoriees
...
app.use('/api/', require('./src/routes/courses')); //categories
app.use('/api', require('./src/routes/modules'));  //sections
app.use('/api', require('./src/routes/AssessmentVideo'));  //Video + Quiz
