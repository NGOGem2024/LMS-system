...
} = require("./src/utils/dbSwitcher");
// const certificates = require();
...
app.use(
  "/api/ngo/certificates",
  require("./src/routes/ngoRoutes/certifications")
);

app.use("/api/ngo/courses", require("./src/routes/ngoRoutes/courses"));

app.use('/api/ngo/docs', require('./src/routes/ngoRoutes/Documentation'));
